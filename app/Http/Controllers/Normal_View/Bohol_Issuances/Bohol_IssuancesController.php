...
class Bohol_IssuancesController extends Controller
{
    public function index(){
        ...
        $issuances = Bohol_Issuance::orderBy('date', 'DESC')->limit(6)->get();
    ...
    public function show( $id){
        ...
        $issuances = Bohol_Issuance::orderBy('date', 'DESC')->limit(3)->get();;
    ...
    public function download( Request $request, $file){
        ...
        return response()->download('/home/dilgboho/DILG_IS/public/issuance_files/'.$file);
