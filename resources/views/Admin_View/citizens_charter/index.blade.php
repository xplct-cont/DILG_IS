    ...
    @endif
                                ...
                                <div class="container mx-auto">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-center" name="page_num" style="width: 60px;" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
        ...
        <div class="elevation-1 p-3 rounded mt-2">
            <div class="card-header d-flex justify-content-between mb-1">
                ...
                <h1 class="" style="font-size: 18px; font-weight: 450;"><span class="fas fa-users-slash"
                        style="color:#8c0509;"></span> CITIZENS CHARTER </h1>
            </div>
                ...
                <tbody class=" text-dark">
                    @foreach ($citizens_charter as $cit_chart)
                        <tr>
                            ...
                            <td><img class="rounded" src="{{ asset('citizens_charter_images/' . $cit_chart->images) }} " alt="Image"
                                style=" height: 80px; width: 90px;"></td>
                                            ...
                                            <form action="{{ url('update-citizens_charter/' . $cit_chart->id) }}"
                                                ...
                                                <div class="container mx-auto">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="" style="color:dimgray">Page Number: </label>
                                                                <input type="text" class="form-control text-center" style="width: 60px;" name="fname"
