                ...
                <div class="col-md-4 text-center d-flex justify-content-center">
                    <div class="">
                        <img src="{{ asset('org_profile_images/' . $d_ones->profile_img) }} " alt="Image"
                            class="shadow-lg border border-dark" style="border-radius: 50%; height: 150px; width: 150px;">
                        <p class="text-center" style="font-size: 18px; font-weight:500;">{{ $d_ones->fname }}
                            {{ $d_ones->mid_initial }} {{ $d_ones->lname }}</p>
                        <p class="text-center" style="margin-top: -20px; font-size: 13px;">{{ $d_ones->position }}</p>
                    </div>
                </div>
            ...
            @foreach ($admin_ser as $ad_ser)
                <div class="col-md-4 text-center d-flex justify-content-center">
                    <div class="">
                        ...
                        <p class="text-center" style="margin-top: -20px; font-size: 13px;">{{ $ad_ser->position }}</p>
                    </div>
                </div>  
            @endforeach
        </div>      
